...
def main():
    seed_everything()
    train_dataset = Aff2_Dataset_static_shuffle(root='../data/labels_save/action_unit/Train_Set/',
    ...
    valid_dataset = Aff2_Dataset_static_shuffle(root='../data/labels_save/action_unit/Validation_Set/',
